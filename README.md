...
#### 1. Project Goal
To digitize school administration and provide parents with a transparent, "window-into-the-school" experience through real-time data synchronization.

#### 2. Functional Requirements
- **Admin App:** Meal logging (Menu/Egg/Milk), Facility status tracking, Announcement broadcasting, Student achievement wall.
- **Parent Portal:** Live feed of today's menu, facility status overview, chronological announcements.
